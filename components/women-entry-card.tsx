  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="rounded-2xl border border-violet-200 bg-violet-50 p-3 text-violet-600 transition duration-300 group-hover:scale-105 group-hover:rotate-3">
