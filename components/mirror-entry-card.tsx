...
function MirrorEntryCard({ href = "/mirror", lang = "en" }) {
  ...
  return (
    <a
      href={href}
      className="group block overflow-hidden rounded-[28px] border border-sky-100 bg-gradient-to-br from-sky-50/50 to-blue-50/50 p-6 shadow-[0_10px_40px_rgba(0,0,0,0.06)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_50px_rgba(0,0,0,0.08)]"
    >
