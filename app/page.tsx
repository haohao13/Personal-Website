    ...
    () => [
      {
        ...
        items: ['✈️ Private Pilot License', '🚤 Boater Card', '🤿 Open Water Diver'],
      },
      {
        ...
        items: ['🏊 Swimming', '🏄‍♀️ Surfing', '🩰 Ballet', '🏸 Badminton', '🥊 Boxing', '🚴 Cycling'],
      },
      {
        ...
        items: ['📸 Photography', '💐 Flower Arranging', '🎨 Painting', '🏺 Ceramics', '🥁 Drums', '🎹 Piano','🎸 Guitar'],
      },
      {
